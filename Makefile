all: server/server.o server/static_file.o server/request.o server/Router.o server/LobbyController.o server/Lobby.o
	cd server; g++ -o server -pthread server.o static_file.o request.o Router.o LobbyController.o Lobby.o -lboost_filesystem -lboost_system 
